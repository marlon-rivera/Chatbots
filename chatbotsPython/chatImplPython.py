...
def start():
    return jsonify({"message" : "👋 Welcome to Chatty, your friendly chatbot companion! How can I assist you today? Feel free to ask me anything or just say 'hello' to start the conversation. I'm here to help and chat with you!", "from" : "chatty"})

@app.route('/sendMessage', methods=['POST'])
def response_a_request():
    data = request.get_json()
    message = data.get("message", "")
    response = eliza_chatbot.respond(message)
    print(message)
